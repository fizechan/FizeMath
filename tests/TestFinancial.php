...
//        var_dump($values);
    ...
    public function testIrr()
    {
        ...
        if ($test == 1) {
            ...
            $values = [
                -2300, -2000, -2000, -2000, -2000, -2000, -2000, -2000, -2000, -2000,
                -2000, -2000, 51600, -2300, -2300, -2300, -2300, -2300, -2300, -2300,
    ...
    public function testIrr2()
    {
        ...
        self::assertCount(33, $values);
        $irr = Financial::irr2($values);
        var_dump($irr);
        self::assertIsFloat($irr);
    }
