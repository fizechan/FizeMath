...
class EPP
{
     ...
     */
    public function plans(int $scale = 2, int $fix_issue = -1, bool $with_issue_zero = false)
    {
        $plans = [];
     ...
     */
    public function datePlans(string $loan_date, int $scale = 2, int $fix_issue = -1, bool $with_issue_zero = false)
    {
     ...
     * @return string
     */
    private function getIssueDate(string $loan_date, int $issue)
    {
